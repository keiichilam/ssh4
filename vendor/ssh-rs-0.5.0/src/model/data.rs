...
impl Data {
    ...
    // ssh4 local modification: removed `uninit_new` — the resumable packet
    // reader assembles packets in `Client::recv_buf`, so nothing needs an
    // uninitialized buffer any more.
